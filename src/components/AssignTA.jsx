...
import { assignTA } from "../api/apis";

export default function AssignTA() {
  ...
  const handleAssignTA = async () => {
    ...
    // console.log(object);
    const response = await assignTA(object);
  ...
  return (
    <React.Fragment>
      ...
      <Dialog
        ...
        onClose={handleClose}
      >
        <DialogTitle>Assign TA</DialogTitle>
        <DialogContent>
          <ThemeProvider theme={theme}>
            <Box
              noValidate
        ...
        <DialogActions sx={{ padding: 2 }}>
          <ThemeProvider theme={theme}>
            ...
            {!studentID || !classID ? (
              ...
              <Button variant="contained" onClick={handleAssignTA}>
                Assign
              </Button>
            )}
          </ThemeProvider>
